...
namespace WebAPI.Migrations
{
    ...
    [Migration("20240407172239_AddedDescriptionToLevel")]
    partial class AddedDescriptionToLevel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPI.Models.Models.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI.Models.Models.Level", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI.Models.Models.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI.Models.Models.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI.Models.Models.Theme", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI.Models.Models.Thread", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI.Models.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI.Models.Models.Image", b =>
                {
                    b.HasOne("WebAPI.Models.Models.Post", "Post")
                        .WithMany("Image")
                        .HasForeignKey("PostId")
                        .HasConstraintName("FK_Image_Post");

                    b.HasOne("WebAPI.Models.Models.Theme", "Theme")
                        .WithMany("Image")
            ...
            modelBuilder.Entity("WebAPI.Models.Models.Post", b =>
                {
                    b.HasOne("WebAPI.Models.Models.Post", "ReplyToPost")
                        .WithMany("InverseReplyToPost")
                        .HasForeignKey("ReplyToPostId")
                        .HasConstraintName("FK_Post_Post");

                    b.HasOne("WebAPI.Models.Models.Thread", "Thread")
                        .WithMany("Post")
                        .HasForeignKey("ThreadId")
                        .IsRequired()
                        .HasConstraintName("FK_Post_Thread");

                    b.HasOne("WebAPI.Models.Models.User", "User")
                        .WithMany("Post")
            ...
            modelBuilder.Entity("WebAPI.Models.Models.User", b =>
                {
                    b.HasOne("WebAPI.Models.Models.Level", "Level")
                        .WithMany("User")
